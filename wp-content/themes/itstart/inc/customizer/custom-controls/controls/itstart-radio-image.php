...
/**
 * ItStart
 * Customizer Control: ItStart Radio Image control
 */

class ItStart_Customize_Control_Radio_Image extends ItStart_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'itstart-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="itstart-radio-image-select">
