            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#ItStart_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('ItStart_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="itstart_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="itstart_feature_thumbnail-button">Change Image</button> ' +
