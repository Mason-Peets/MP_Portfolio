 ...
 * @access public
 */
class ItStart_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * ItStart_Customizer_Range_Control constructor.
	 *
 ...
 */
function itstart_sanitize_range_value( $input ) {
	if ( itstart_is_json( $input ) ) {
 ...
 * @param  string $string Input.
 */
function itstart_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
