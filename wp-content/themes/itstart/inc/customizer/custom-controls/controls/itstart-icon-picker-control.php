 ...
 * @package     ItStart
 * @author      ItStart
 * @copyright   Copyright (c) 2022, ItStart_
 * @since       1.0
 */
...
class ItStart_Icon_Picker_Control extends WP_Customize_Control
{
  ...
  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->ItStart_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'itstart-icon-picker-css', ITSTART_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.css', false );
			 
		wp_enqueue_script( 'itstart-icon-picker-js', ITSTART_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
