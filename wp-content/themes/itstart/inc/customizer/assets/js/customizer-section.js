...
function itstart_frontpagesectionsscroll( section_id ){
 ...
 jQuery('body').on('click', '#sub-accordion-panel-itstart_homepage_sections .control-subsection .accordion-section-title', function(event) {
        var section_id = jQuery(this).parent('.control-subsection').attr('id');
        itstart_frontpagesectionsscroll( section_id );
});