...
( function( $ ) {
	...
	ITSTART_ControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'itstart-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'itstart-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'itstart-control-trigger.' + hook, callback );
	    },
	};
	 ...
	 *
	 * @since 1.0.0
	 * @class ITSTART_CustomizerToggles
	 */
	ITSTART_CustomizerToggles = {
		...
		[
			{
				...
				callback: function( itstart_header_type ) {

					var itstart_header_type = api( 'itstart_header_type' ).get();

					if ( 'header-1' == itstart_header_type  || 'header-4' == itstart_header_type  || 'header-5' == itstart_header_type  || 'header-6' == itstart_header_type  || 'header-7' == itstart_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-1' == itstart_header_type  || 'header-4' == itstart_header_type || 'header-6' == itstart_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-4' == itstart_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-4' == itstart_header_type  || 'header-5' == itstart_header_type || 'header-6' == itstart_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-5' == itstart_header_type  || 'header-7' == itstart_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-5' == itstart_header_type || 'header-6' == itstart_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-6' == itstart_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( itstart_header_type ) {
					...
					if ( 'header-7' !== itstart_header_type) {
						return true;
					}
					return false;
				}
		...
		[
			{
				...
				callback: function( itstart_footer_type ) {

					var itstart_footer_type = api( 'itstart_footer_type' ).get();

					if ( 'footer-one' == itstart_footer_type || 'footer-two' == itstart_footer_type ) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( itstart_footer_type ) {
					...
					if ( 'footer-two' == itstart_footer_type ) {
						return true;
					}
					return false;
				}
