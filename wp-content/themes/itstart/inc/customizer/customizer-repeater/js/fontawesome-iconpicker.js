(function ($) {
    ...
    wp.itstart_customizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                itstart_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.itstart_customizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.itstart_customizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.itstart_customizerRepeater.iconPickerToggle($(this));
        });
