 ...
 */
function itstart_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function itstart_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function itstart_sanitize_html( $html ) {
 ...
 */
function itstart_sanitize_image( $image, $setting ) {
 ...
 */
function itstart_sanitize_nohtml( $nohtml ) {
 ...
 */
function itstart_sanitize_number_absint( $number, $setting ) {
 ...
 */
function itstart_sanitize_select( $input, $setting ) {
 ...
 */
function itstart_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function itstart_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function itstart_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function itstart_sanitize_sortable( $val, $setting ) {
...
function itstart_sanitize_typography_fonts( $input ) {
	$standard = itstart_font_selector_get_standard_fonts();
	$google = itstart_font_selector_get_google_fonts_array();
